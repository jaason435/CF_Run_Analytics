		...
		<nav class="navbar navbar-expand-lg navbar-light">
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
			  ...
			  <li class="nav-item">
				<button type="button" class="btn  btn-md btn-block purple-btn purple-btn-active" onclick="window.parent.location.href = window.location.origin + '/perWeek.cfm'">Per Week</button>
			  </li>&nbsp;
			  <li class="nav-item">
		...
		<div class="row">
			<div class="details-container">
				<div class="inner-content">
					<h5 style="color:#898989;margin-top:1em;">Interactive Charts Coming Soon!</h5>
				</div>	
			</div>
		</div>
	</div>
...
.inner-content {
    ...
    width: 60em;
	min-height: 20em;
	 background-color:rgba(105, 54, 158, 0.8);
	text-align: center;
}
